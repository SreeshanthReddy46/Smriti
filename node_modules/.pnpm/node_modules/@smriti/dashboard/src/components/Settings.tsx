...
export default function Settings({ status, onScan, syncing, fetchStatus, privacyMode }: SettingsProps) {
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                ...
                <input 
                  ...
                  placeholder={privacyMode ? "••••••••••••••••" : "e.g. C:\\Users\\hp\\my-project"}
                  className="w-full px-4 py-2.5 text-sm border border-slate-200 rounded-xl focus:outline-none focus:border-sky-300 font-medium font-mono"
                />
