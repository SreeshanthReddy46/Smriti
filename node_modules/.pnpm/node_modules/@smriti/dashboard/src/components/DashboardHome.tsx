...
export default function DashboardHome({ status, fetchStatus, setActiveTab, privacyMode }: HomeProps) {
  const cards = [
    {
      title: "Workspace Path",
      value: status.repo_loaded && status.repository ? status.repository.name : "Not Loaded",
      desc: status.repo_loaded && status.repository ? maskPath(status.repository.path, privacyMode) : "Set repository folder in Settings",
      icon: Folder,
