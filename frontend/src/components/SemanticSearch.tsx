        ...
        <div className="space-y-8 animate-fade-in">
          ...
          {promptContext && (
            <div className="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm space-y-4">
              ...
              {showContext && (
                <pre className="font-mono text-[10px] p-4 bg-slate-50 border border-slate-100 rounded-xl text-slate-500 overflow-x-auto whitespace-pre-wrap max-h-72">
                  {promptContext}
                </pre>
              )}
            </div>
                ...
                {citations.map((cite) => (
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <p className="text-xxs font-medium font-mono text-slate-500 bg-slate-50/50 p-2.5 rounded-lg border border-slate-100/50 line-clamp-3">
                        {cite.snippet}
                      </p>
                    </div>
                  </div>
